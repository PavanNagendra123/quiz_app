...
import { signupStyles } from '../dummyStyles';
import { Link, useNavigate } from 'react-router-dom';
import { ArrowLeft, CheckCircle, Eye, EyeOff, Lock, Mail, User } from 'lucide-react';
const isValidEmail = (email) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email); //wheather email is @ or not 
                ...
                <div className={signupStyles.animatedBorder}>
                    <div className={signupStyles.formContent}>
                        ...
                        <p className={signupStyles.subtitle}>
                            Sign in to continue to Pavan Quiz. Light, clean UI - smooth
